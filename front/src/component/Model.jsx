...
function Model({ open, onClose, id_staple, nameS, grams }) {
  ...
  const handleSelectQuantity = (item, quantity) => {
    // อัปเดต selectedAmounts ให้มี key เป็น id_lot และ value เป็นปริมาณที่เลือก
    setSelectedAmounts((prevSelectedAmounts) => ({
      ...prevSelectedAmounts,
      [item.id_lot]: quantity,
    }));
  };
                        ...
                        >
                          ...
                          <td>
                            <input
                              ...
                              type="number"
                              value={selectedAmounts[item.id_lot] || 0}
                              onChange={(e) => {
                            ...
                            <button
                              ...
                              onClick={() => handleSelectQuantity(item, 0)}
                            > 
                              ตกลง
                            </button>
                          </td>
